...
% the user and the way he enumerate all possible phases.

% MinNumCycles, MaxNumCycles= set these values for the number of cyles and
% the function will pick the numCyles randomly from a 
...
% maxManeuver, minManeuver: the maximum and Minimum number of maneuvers a
...
function [syntheticFixTimeData,phaseSequence] =...
